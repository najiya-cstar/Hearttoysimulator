...
This code uses JAMA paper code (https://github.com/kevinz1194/Heart-Continuous-Score) to build the longitudinal candidate dataset. Their code nice summarizes all the steps required to build the data
